...
def save_grid_overview_png(
    ...
    samples: list of dicts with keys:
      - name: sample stem
      - x: np.ndarray fluorescence values
      - y: np.ndarray FSC values
    """
    out_dir.mkdir(parents=True, exist_ok=True)
...
def main():
    ...
    # Store transformed arrays for the all-samples overview grid
    ...
    # All-samples overview grid remains directly inside OUTPUT_FOLDER
