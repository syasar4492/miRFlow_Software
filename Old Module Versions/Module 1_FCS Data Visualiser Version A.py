...
def main():
    ...
    # -----------------------------------------------------------------
    INPUT_FOLDER = Path(
        r"D:\ICL MBE\Year 4\FYP\Software Automation\Raw Flow Data\06.16.2025_20samples_optimized protocol"
    )
    ...
    # -----------------------------------------------------------------
    OUTPUT_FOLDER = Path(
        r"D:\ICL MBE\Year 4\FYP\Software Automation\Visual Flow Data\20 samples optimised protocol"
    )
